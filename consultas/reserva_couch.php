<?php 
	...
	$queryReservar="SELECT * FROM reserva WHERE (('".$fDesde."' BETWEEN finicio AND fFin) OR ('".$fHasta."' BETWEEN finicio AND fFin) OR (finicio BETWEEN '".$fDesde."' AND '".$fHasta."') OR (ffin BETWEEN '".$fDesde."' AND '".$fHasta."')) AND (id_couch='".$_POST["id_couch"]."') AND (estado = 'Aceptada')";
